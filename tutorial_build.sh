...
# Base directory for the tutorial (hardcoded as per original script)
BASE_DIR="/home/hep/llaatu/mach3/MaCh3Tutorial"

# Argument 2: Build Directory Name (Default: "build")
BUILD_DIR_NAME="${2:-build}"
FULL_BUILD_PATH="${BASE_DIR}/${BUILD_DIR_NAME}"
